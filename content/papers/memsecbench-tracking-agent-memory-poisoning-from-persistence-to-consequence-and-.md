...
从摘要来看，作者主要关注的是：Memory systems allow agents to retain and reuse information from past interactions, but they can also let malicious content persist.

进一步看，论文的核心做法或实验重点可以概括为：A malicious instruction crafted by an attacker may be stored in long-term memory, recalled much later, and quietly shape a real action.
